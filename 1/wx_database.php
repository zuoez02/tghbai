...
<body>
    ...
    <!-- <div name="search" style="height:100px; overflow:hidden;" align="center">
        <form action="wx_database.php" method="post" align="center">
            <div id="searchdiv" >
                <label for="search-basic">搜索指定昵称:</label>
            </div>
            <div id="searchdiv">
                <input type="search" name="search-input" id="searc-basic" value="" data-mini="true" />
            </div>
            <div id="searchdiv">
                <a href="index.php" data-role="button">确定</a>
            </div>
        </form>        
    </div>-->
