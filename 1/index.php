...
<html>
    ...
    <body style="padding:0px">
        ...
        <div data-role="navbar" id="navbar">
            <ul data-theme="d">                
                <li style="text-indent: 0;"><a href="index.php" class='ui-btn-active' data-ajax="false"><span>主页</span></a></li>
        ...
        <a href="http://tghbai.sinaapp.com/video/0001.php" data-ajax="false">
            ...
            <?php
                ...
                {
                   ?>
            		仅管理可以看见此内容<a href="http://tghbai.sinaapp.com/BBSmini/BBSindex.php" ><u>进入mini论坛</u></a>
            		<?php
                }
            ?>
